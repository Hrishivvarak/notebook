...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Stream<QuerySnapshot> _getnotebooks()
  {
    return _db.collection('users').doc(userid).collection('notebooks').orderBy('createdAt').snapshots();
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
            ...
            //meow**************************************************************************************
              Center(
                child: Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(stream: _getnotebooks(),
                      builder: (context, snapshot)
                  {
                    ...
                    if(!snapshot.hasData || snapshot.data!.docs.isEmpty)
                      {
                        return Center(child: Text("No notebooks yet."));
                      }
                        ...
                        children: notebooks.map((doc){
                          ...
                          return Slidable(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => NotebookOpen(title: title ,notebookid: doc.id),),);
                              },
                              child: Container(
                                height: 55,
                                width: double.infinity,
        ...
        child: FloatingActionButton(onPressed: (){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CreateNotebook()));
        },
